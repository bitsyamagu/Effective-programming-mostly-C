...
> 実験等の経験のない会社員の人は、会社のオフィスがフリーアドレス方式になって、自分の固定席がなくなることを想像してみてください。それが全部ヒープでスタックがないという状況です。自分の読み差しの本をデスクに置きっぱなしにすることはできませんし、夜通しPCを起動したままにしておいて計算することもできません。おまけにちょっと目を離すと自分の座る場所すらもなくなります。
